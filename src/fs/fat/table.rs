...
///
/// Defined by the allocation-free core so both halves of this backend
/// speak the same type; re-exported here because that is where the
/// hosted code has always named it.
pub use crate::fs::fat::FatKind;
